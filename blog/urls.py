...
from blog.views import equipo, listar_partidos, agregar_jugador, buscar_jugadores, home, jugadorList, jugadorDetail, jugadorCreate, jugadorUpdate, jugadorDelete, about
from .views import listar_partidos
